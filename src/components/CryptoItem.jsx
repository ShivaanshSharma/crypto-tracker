...
export default function CryptoItem ({itemData}) {
    ...
    return (
        <div className=" duration-150 cursor-pointer text-xs text-center lg:text-base md:text-base sm:text-base my-3 bg-blue-950 flex items-center  flex-row  rounded-2xl p-2 hover:border-yellow-200 gap-6">
