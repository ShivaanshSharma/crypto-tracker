...
export default function CryptoItem ({itemData}) {
    ...
    return (
        <div className="text-sm lg:text-base md:text-base sm:text-base my-3 flex items-center text-center flex-row border-2 border-white rounded-full p-2 hover:border-gray-400 gap-6">
